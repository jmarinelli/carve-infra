...
DataCar (Argentina) and similar aggregators offer institutional data — title history, fines, liens. That is their entire product. This platform offers that baseline PLUS verified condition data from a network of professional inspectors and workshops. Building that network takes years. It is the moat.

- DataCar → "who owned it, does it have fines" → commodity
- This platform → that PLUS "a mechanic inspected it 3 months ago and here's exactly what they found" → differentiated
